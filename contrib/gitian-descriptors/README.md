...
--Updated 4/5/2014 by VectrumDevs--
--fixed QT source Links--
--Updated to Vectrum Folders--
--updated links to boost 1_55_0
--Added FAQ--



<img src="http://Vectrum.com/splash.png" alt="Vectrum">
...
Once you've got the right hardware and software:
    ...
    https://github.com/VectroNetwork/vectrum.git
    ...
    cd ../gitian-builder
    git pull
    sudo ./bin/gbuild --commit Vectrum=HEAD ../Vectrum/contrib/gitian-descriptors/gitian.yml

    # Build Win32 dependencies: (only needs to be done once, or when dependency versions change)
    sudo ./bin/gbuild --commit Vectrum=HEAD ../Vectrum/contrib/gitian-descriptors/boost-win32.yml
    sudo ./bin/gbuild --commit Vectrum=HEAD ../Vectrum/contrib/gitian-descriptors/deps-win32.yml
    sudo ./bin/gbuild --commit Vectrum=HEAD ../Vectrum/contrib/gitian-descriptors/qt-win32.yml

    # Build Win32 release:
    sudo ./bin/gbuild --commit Vectrum=HEAD ../Vectrum/contrib/gitian-descriptors/gitian-win32.yml
...
If you need more help please visit Vectrum Forum at www.Vectrum.rocks
